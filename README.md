...
## 📚 Description
This project consists of the implementation of an LL(1) lexical and syntactic analyzer for the X++ language, developed as a practical assignment for the Compilers course. The lexical analyzer reads the source code and recognizes the language tokens, while the syntactic analyzer verifies whether the token sequence conforms to the defined LL(1) grammar, identifying syntactic errors when present.
